...
{if isset($showAd)}
    {foreach from=$showAd item=ad key=id }
	<p>{$ad.date} | <a href="dz_8.php?show={$id}">{$ad.title}</a> | {$ad.price|string_format:"%.2f"} руб. | {$ad.seller_name} | <a href="dz_8.php?delete={$id}">Удалить</a></p>
    {/foreach}
{/if}
